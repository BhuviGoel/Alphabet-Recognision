...
#Fetching the data
X = np.load(r'C:\Users\bhuvi\Google Drive\Coding\Python\Project 123 - Digital Recognisation\image.npz')['arr_0']
y = pd.read_csv(r"C:\Users\bhuvi\Google Drive\Coding\Python\Project 123 - Digital Recognisation\labels.csv")["labels"]
